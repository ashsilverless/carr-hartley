...
while ( have_rows('gallery') ) : the_row();?>
    ...
    <div class="gallery__fullwidth slide-up">
        ...
        <?php endif;?>
        <?php if($imageType == 'no') :?>
            <a href="<?php echo $image['url']; ?>" class="lightbox-gallery <?php echo $imageType;?>"  alt="<?php echo $image['alt']; ?>" style="background-image: url(<?php echo $image['url']; ?>); height:<?php echo $imageHeight;?>vh;">
            <?php if ($image['caption']) {?>
                <span><?php echo $image['caption']; ?></span>
            <?php }?>
            </a>
...
<?php elseif( get_row_layout() == 'halves' ):?>
    ...
    <div class="gallery__halves slide-up">
        ...
        $halfImage = get_sub_field('half_image');?>
            <a href="<?php echo $halfImage['url']; ?>" class="lightbox-gallery"  alt="<?php echo $halfImage['alt']; ?>" style="background-image: url(<?php echo $halfImage['url']; ?>); height:<?php echo $imageHeight;?>vh;">
            <?php if ($halfImage['caption']) {?>
                <span><?php echo $halfImage['caption']; ?></span>
            <?php }?>
            </a>
...
<?php elseif( get_row_layout() == 'three-images' ):?>
    ...
    <div class="gallery__three-images <?php echo $alignment;?> slide-up" style="height:<?php echo $imageHeight;?>vh;">
        ...
        $halfImage = get_sub_field('tri_image');?>
            <a href="<?php echo $halfImage['url']; ?>" class="lightbox-gallery"  alt="<?php echo $halfImage['alt']; ?>" style="background-image: url(<?php echo $halfImage['url']; ?>);"
            <?php if ($halfImage['caption']) {?>
                <span><?php echo $halfImage['caption']; ?></span>
            <?php }?>
            </a>
